...
export default function Slider({ items }: SliderProps) {
  ...
  return (
    <div className="relative w-full h-[90vh] overflow-hidden">
      ...
      {/* CONTENT */}
      <div className="relative z-10 h-full flex flex-col justify-center px-16 text-white max-w-3xl">
        <h1 className="text-5xl font-bold leading-tight drop-shadow-lg">
          {items[current].title}
        </h1>

        <p className="mt-4 text-lg opacity-90">{items[current].description}</p>
      ...
      {/* SMALL IMAGES */}
      <div className="absolute bottom-20 left-[70%] -translate-x-1/2 flex gap-4 z-10">
      ...
      {/* ARROWS */}
      <div className="absolute bottom-12 left-[32%] -translate-x-1/2 flex gap-3 z-10">
        <button
